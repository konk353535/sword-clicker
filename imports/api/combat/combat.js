...
const CombatSchema = new SimpleSchema({
    ...
    "stats.magicPools": { type: Number, decimal: true, defaultValue: 0, optional: true },
    "stats.fireReserve": { type: Number, decimal: true, defaultValue: 0, optional: true },
    "stats.earthReserve": { type: Number, decimal: true, defaultValue: 0, optional: true },
    "stats.airReserve": { type: Number, decimal: true, defaultValue: 0, optional: true },
    "stats.waterReserve": { type: Number, decimal: true, defaultValue: 0, optional: true },
    "stats.necroticReserve": { type: Number, decimal: true, defaultValue: 0, optional: true },

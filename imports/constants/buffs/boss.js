        ...
        events: {
                    ...
                    allMonsters.forEach((selectedMonsterId) => {
                        ...
                        const monster = {
                            ...
                            stats: {
                                ...
                                attack: (room / 1.8) * 3.8 * floor * (1 + floor / 3.3),
            ...
            onTick({ buff, target, caster, secondsElapsed, actualBattle }) {
                if (buff.data.timeTillResurrection > 0) {
                    ...
                    const enemy = _.sample(
                        buff.data.internal_genericTowerMonsterGenerator(actualBattle.floor, roomToSpawn)
                    )
    ...
    boss_hive: {
        ...
        events: {
            ...
            onTick({ buff, target, caster, secondsElapsed, actualBattle }) {
                ...
                buff.stacks = Math.round(
                    (1 - (buff.data.damageLimit - buff.data.damageTaken) / buff.data.damageLimit) * 100
                )
            },
    ...
    boss_lich: {
        ...
        events: {
            ...
            onTick({ buff, target, caster, secondsElapsed, actualBattle }) {
                ...
                if (
                    !target.isStunned &&
                    !target.isCharmed /* && target.isAbleToUseAbilities && target.isAbleToCastSpells */
                ) {

...
export const ARCHER_ITEMS = {
  ...
  fiery_bow: {
    ...
    stats: {
      ...
      attackMax: 300 * RADIANT_MULTIPLIER * DARKSTEEL_MULTIPLIER * BATTLEAXE_TO_BOW_ATTACKMAX,
      attackSpeed: SLOW_SPEED,
      accuracy: 134.1 * RADIANT_MULTIPLIER * DARKSTEEL_MULTIPLIER * BATTLEAXE_TO_BOW_ACCURACY,
      criticalChance: 25
    },
    extraStats: {
      attack: 25.1 * RADIANT_MULTIPLIER * BATTLEAXE_TO_BOW_ATTACKMIN,
      attackMax: 90 * RADIANT_MULTIPLIER * DARKSTEEL_MULTIPLIER * BATTLEAXE_TO_BOW_ATTACKMAX
    },
    requiredEquip: [{
      type: 'skill',
      name: 'attack',

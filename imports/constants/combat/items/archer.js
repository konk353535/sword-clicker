...
export const ARCHER_ITEMS = {
  ...
  ebony_bow: {
    ...
    description: 'A slow but powerful ranged weapon of polished ebony and filigree darksteel metals.  Bows are useless without quivers.',
    isTwoHanded: true,
    isWeapon: true,
    isEquippable: true,
    stats: {
  ...
  fiery_bow: {
    ...
    description: 'A slow but powerful ranged weapon of ember-lit, charred wood and filigree radiant metals.  Bows are useless without quivers.',
    isTwoHanded: true,
    isWeapon: true,
    isEquippable: true,
    stats: {
  ...
  tamarind_bow: {
    ...
    description: 'A slow but powerful ranged weapon of polished tamarind and filigree astral metals.  Bows are useless without quivers.',
    isTwoHanded: true,
    isWeapon: true,
    isEquippable: true,
    stats: {
  ...
  magic_bow: {
   ...
   description: 'A slow but powerful ranged weapon of magic-imbued wood and filigree titanfoil metals.  Bows are useless without quivers.',
    isTwoHanded: true,
    isWeapon: true,
    isEquippable: true,
    stats: {
  ...
  petrified_bow: {
    ...
    description: 'A slow but powerful ranged weapon of petrified wood and rune-covered relicrock metals.  Bows are useless without quivers.',
    isTwoHanded: true,
    isWeapon: true,
    isEquippable: true,
    stats: {
  ...
  ancient_bow: {
    ...
    description: 'A slow but powerful ranged weapon of ancient wood and faintly-glowing eternium metals.  Bows are useless without quivers.',
    isTwoHanded: true,
    isWeapon: true,
    isEquippable: true,
    stats: {

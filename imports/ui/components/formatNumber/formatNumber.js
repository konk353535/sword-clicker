...
import { IsValid, CInt, CDbl, True, False, autoPrecisionValue } from '/imports/utils';
...
Template.formatNumber.helpers({
  formattedNumber() {
    ...
    options.showDecimal = options.wantForcedDecimal || (options.haveDecimalPrecision && (Math.floor(number) != number));

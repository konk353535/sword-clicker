...
Template.achievementsPage.onCreated(function bodyOnCreated() {
    ...
    Tracker.autorun(() => {
        ...
        if (userDoc) {
            ...
            this.state.set(
                "damageTaken",
                userDoc.stats && userDoc.stats.combatMostDamageTaken ? userDoc.stats.combatMostDamageTaken : 0
            )
            this.state.set(
                "damageDone",
                userDoc.stats && userDoc.stats.combatMostDamageDone ? userDoc.stats.combatMostDamageDone : 0
            )
            this.state.set(
                "healingDone",
                userDoc.stats && userDoc.stats.combatMostHealingDone ? userDoc.stats.combatMostHealingDone : 0
            )
        }
    })
})

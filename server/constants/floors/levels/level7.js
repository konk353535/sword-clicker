...
export const LEVEL_SEVEN_LOOT_TABLE = orderLootTable([
    ...
    {
        chance: 1 / 64,
        rewards: [{ type: "item", itemId: "gold_essence_scroll", amount: 1 }]
    },
    {
        chance: 1 / 64,
        rewards: [{ type: "item", itemId: "thirsty_fangs_1_tome_scroll", amount: 1 }]
    },
    {
        chance: 1 / 64,
        rewards: [{ type: "item", itemId: "healing_power_up_level_1_tome", amount: 1 }]
    },
    {
        chance: 1 / 24,

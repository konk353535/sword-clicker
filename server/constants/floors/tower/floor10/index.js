...
export const TOWER_FLOOR_10 = {
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_TEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "titanium_knife", amount: 1 }]
                },
                {
                    chance: 1 / 96,
                    rewards: [{ type: "icon", iconId: "hiti_t1" }]
                },
                {
                    chance: 1 / 256,
                    rewards: [{ type: "icon", iconId: "hiti_t1_color" }]
                }
            ])
        )
    },
    4: {
        ...
        enemies: ["titanium_spirit", "titanium_spirit"],
        rewards: orderLootTable(
            LEVEL_TEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "titanium_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "titanium_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_TEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "titanium_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "titanium_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "titanium_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_TEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "titanium_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "armor_up_new_level_4_tome", amount: 1 }]
                }
            ])
        )
    },
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_TEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "inferno_tome", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "titanium_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_TEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "demons_heart", amount: 1 }]
                }
            ])
        )
    },

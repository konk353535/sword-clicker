    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_ELEVEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tungsten_knife", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_ELEVEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tungsten_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "tungsten_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_ELEVEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tungsten_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tungsten_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tungsten_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                        { type: "item", itemId: "umber_wizard_hat", amount: 1 },
                        { type: "item", itemId: "umber_wizard_shirt", amount: 1 },
                        { type: "item", itemId: "umber_wizard_shorts", amount: 1 }
                    ]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "umber_trident", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "precise_shots_level_3_tome", amount: 1 }]
                }
            ])
        )
    },
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_ELEVEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "tungsten_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "health_up_4_tome", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "magic_armor_up_level_4_tome", amount: 1 }]
                }
            ])
        )
    },
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_ELEVEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 96,
                    rewards: [{ type: "item", itemId: "blizzard_tome", amount: 1 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "mending_spring_tome", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                    rewards: [{ type: "item", itemId: "water_shard_fragment", amount: 50 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "tungsten_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [

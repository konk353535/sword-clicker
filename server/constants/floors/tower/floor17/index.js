...
export const TOWER_FLOOR_17 = {
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_SEVENTEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 8,
                    rewards: [
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "meteorite_knife", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_SEVENTEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "meteorite_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                    rewards: [{ type: "item", itemId: "meteorite_essence", amount: 1 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "meteorite_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_SEVENTEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "meteorite_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "meteorite_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "meteorite_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 128,
    ...
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_SEVENTEEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "meteorite_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "health_up_5_tome", amount: 1 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "magic_armor_up_level_5_tome", amount: 1 }]
                }
            ])
        )
    },
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_SEVENTEEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 16,
                    rewards: [{ type: "item", itemId: "complete_air_shard", amount: 10 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "meteorite_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_SEVENTEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "krakens_tentacle", amount: 1 }]
                }
            ])
        )
    },

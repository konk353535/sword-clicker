...
export const TOWER_FLOOR_19 = {
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_NINETEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 8,
                    rewards: [
    ...
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_NINETEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "elven_steel_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "elven_steel_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_NINETEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "elven_steel_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "elven_steel_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "elven_steel_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                        ...
                        { type: "item", itemId: "amber_wizard_shorts", amount: 1 }
                    ]
                },
                {
                    chance: 1 / 128,
                ...
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "power_shot_level_5_tome", amount: 1 }]
                }
            ])
        )
    },
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_NINETEEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "elven_steel_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "healing_power_up_level_5_tome", amount: 1 }]
                }
            ])
        )
    },
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_NINETEEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "lightning_speed_tome", amount: 1 }]
                },
                {
                    chance: 1 / 16,
                    rewards: [{ type: "item", itemId: "complete_water_shard", amount: 10 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "elven_steel_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [

...
import { LEVEL_TWO_LOOT_TABLE } from "../../levels/level2"
...
export const TOWER_FLOOR_2 = {
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_TWO_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tin_knife", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_TWO_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tin_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "brown_trident", amount: 1 }]
                },
                {
                    chance: 1 / 16,
                    rewards: [
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "tin_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_TWO_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tin_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tin_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "spiked_armor_1_tome", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "tin_buckler", amount: 1 }]
                }
            ])
        )
    },
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_TWO_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "tin_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_TWO_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "tin_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_TWO_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "snake_skin_chest", amount: 1 }]
                }
            ])
        )
    },

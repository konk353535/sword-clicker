...
export const TOWER_FLOOR_21 = {
    ...
    2: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_ONE_LOOT_TABLE.concat([
                {
                    chance: 1 / 16,
                    rewards: [
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_ONE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "darksteel_knife", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [{ type: "item", itemId: "ebony_bow_scroll", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [{ type: "item", itemId: "darksteel_quiver_scroll", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_ONE_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "darksteel_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 16,
                    rewards: [
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "darksteel_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_ONE_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "darksteel_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "darksteel_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "darksteel_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 16,
                    rewards: [
                ...
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "precise_shots_level_5_tome", amount: 1 }]
                }
            ])
        )
    },
            ...
            LEVEL_TWENTY_ONE_LOOT_TABLE.concat([
                ...
                },
                {
                    ...
                    rewards: [
                        ...
                        { type: "item", itemId: "forgotten_tome", amount: 1 }
                    ]
                }
            ])
        )
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_ONE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "darksteel_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_ONE_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "eternal_flame", amount: 1 }]
                }
            ])
        )
    },

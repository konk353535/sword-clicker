...
export const TOWER_FLOOR_25 = {
    ...
    2: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_FIVE_LOOT_TABLE.concat([
                {
                    chance: 1 / 24,
                    rewards: [
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_FIVE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "relicrock_knife", amount: 1 }]
                },
                {
                    chance: 1 / 40,
                    rewards: [{ type: "item", itemId: "petrified_bow_scroll", amount: 1 }]
                },
                {
                    chance: 1 / 40,
                    rewards: [{ type: "item", itemId: "relicrock_quiver_scroll", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_FIVE_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "relicrock_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "relicrock_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_FIVE_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "relicrock_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 40,
                    rewards: [{ type: "item", itemId: "relicrock_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "relicrock_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "exalted_trident", amount: 1 }]
                }
            ])
        )
    },
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_FIVE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 80,
                    rewards: [{ type: "item", itemId: "relicrock_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 40,
                    rewards: [
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_FIVE_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "witchs_cauldron", amount: 1 }]
                }
            ])
        )
    },

...
export const TOWER_FLOOR_26 = {
    ...
    2: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SIX_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "eternium_knife", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "ancient_bow_scroll", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "eternium_quiver_scroll", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "eternium_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "eternium_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 192,
                    rewards: [{ type: "item", itemId: "scepter_of_power_scroll", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "eternium_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "eternium_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "eternium_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SIX_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 92,
                    rewards: [{ type: "item", itemId: "eternium_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [

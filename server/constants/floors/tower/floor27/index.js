...
export const TOWER_FLOOR_27 = {
    ...
    2: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SEVEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 64,
                    rewards: [
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SEVEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 1280,
                    rewards: [{ type: "item", itemId: "prismatic_knife", amount: 1 }]
                },
                {
                    chance: 1 / 96,
                    rewards: [{ type: "item", itemId: "spiritroot_bow_scroll", amount: 1 }]
                },
                {
                    chance: 1 / 96,
                    rewards: [{ type: "item", itemId: "prismatic_quiver_scroll", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SEVEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 1280,
                    rewards: [{ type: "item", itemId: "prismatic_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 96,
                    rewards: [
                ...
                {
                    chance: 1 / 1280,
                    rewards: [{ type: "item", itemId: "prismatic_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SEVEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 1280,
                    rewards: [{ type: "item", itemId: "prismatic_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 1280,
                    rewards: [{ type: "item", itemId: "prismatic_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 1280,
                    rewards: [{ type: "item", itemId: "prismatic_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 96,
                    rewards: [
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SEVEN_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 920,
                    rewards: [{ type: "item", itemId: "prismatic_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 480,
                    rewards: [
                ...
                {
                    chance: 1 / 32,
                    rewards: [{ type: "item", itemId: "ore_purestone", amount: 1 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "spiritroot_log", amount: 1 }]
                },
                {
                    chance: 1 / 256,
                    rewards: [{ type: "item", itemId: "purestone_essence", amount: 1 }]
                }
            ])
        )
    },
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_TWENTY_SEVEN_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "lichs_cowl", amount: 1 }]
                },
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "lichs_robes", amount: 1 }]
                },
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "lichs_wraps", amount: 1 }]
                }
            ])
        )
    },

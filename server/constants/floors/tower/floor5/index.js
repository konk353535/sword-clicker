    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_FIVE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 16,
                    rewards: [{ type: "item", itemId: "double_edged_sword_1_tome", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "silver_knife", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_FIVE_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "silver_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 3,
                    rewards: [{ type: "item", itemId: "silver_essence", amount: 1 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "silver_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_FIVE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "silver_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "silver_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "silver_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "blue_trident", amount: 1 }]
                }
            ])
        )
    },
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_FIVE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "silver_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_FIVE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "silver_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                },
                {
                    chance: 1 / 2,
                    rewards: [
                        { type: "item", itemId: "poison_shard_fragment", amount: 5 },
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_FIVE_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "spartan_spear", amount: 1 }]
                }
            ])
        )
    },

...
import { LEVEL_SIX_LOOT_TABLE } from "../../levels/level6"
...
export const TOWER_FLOOR_6 = {
    1: {
        ...
        rewards: [
            {
                chance: 1 / 48,
                rewards: [{ type: "item", itemId: "tamarind_honey", amount: 1 }]
            }
        ]
    },
    2: {
        ...
        rewards: orderLootTable(
            LEVEL_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 32,
                    rewards: [{ type: "item", itemId: "chrysanthemum_seed", amount: 3 }]
                },
                {
                    chance: 1 / 16,
                    rewards: [{ type: "item", itemId: "chilli_seed", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                    rewards: [
    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 4,
                    rewards: [{ type: "item", itemId: "watermelon", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                ...
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "gold_knife", amount: 1 }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "gold_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 3,
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "gold_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "gold_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "gold_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "gold_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 64,
    ...
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_SIX_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "gold_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 256,
                    rewards: [{ type: "item", itemId: "dwarven_staff", amount: 1 }]
                },
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "gold_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_SIX_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "gold_crown_scroll", amount: 1 }]
                }
            ])
        )
    },

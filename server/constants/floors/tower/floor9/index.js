    ...
    3: {
        ...
        rewards: orderLootTable(
            LEVEL_NINE_LOOT_TABLE.concat([
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "lettice", amount: 50 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [{ type: "item", itemId: "catnip", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "platinum_knife", amount: 1 }]
                },
                {
                    chance: 1 / 96,
                    rewards: [{ type: "icon", iconId: "alda_t1" }]
                },
                {
                    chance: 1 / 256,
                    rewards: [{ type: "icon", iconId: "alda_t1_color" }]
                }
            ])
        )
    },
    4: {
        ...
        rewards: orderLootTable(
            LEVEL_NINE_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "platinum_rapiers", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "platinum_wand", amount: 1 }]
                }
            ])
        )
    },
    5: {
        ...
        rewards: orderLootTable(
            LEVEL_NINE_LOOT_TABLE.concat([
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "platinum_kite_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "platinum_spirit_shield", amount: 1 }]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "platinum_buckler", amount: 1 }]
                },
                {
                    chance: 1 / 4,
                    rewards: [{ type: "item", itemId: "carrot", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                        { type: "item", itemId: "black_wizard_hat", amount: 1 },
                        { type: "item", itemId: "black_wizard_shirt", amount: 1 },
                        { type: "item", itemId: "black_wizard_shorts", amount: 1 }
                    ]
                },
                {
                    chance: 1 / 128,
                    rewards: [{ type: "item", itemId: "black_trident", amount: 1 }]
                },
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "power_shot_level_3_tome", amount: 1 }]
                }
            ])
        )
    },
    6: {
        ...
        rewards: orderLootTable(
            LEVEL_NINE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 8,
                    rewards: [{ type: "item", itemId: "platinum_bar", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
                ...
                {
                    chance: 1 / 48,
                    rewards: [{ type: "item", itemId: "defense_up_4_tome", amount: 1 }]
                }
            ])
        )
    },
    7: {
        ...
        rewards: orderLootTable(
            LEVEL_NINE_LOOT_TABLE.concat([
                ...
                {
                    chance: 1 / 64,
                    rewards: [{ type: "item", itemId: "platinum_hammer", amount: 1 }]
                },
                {
                    chance: 1 / 32,
                    rewards: [
    ...
    boss: {
        ...
        rewards: orderLootTable(
            LEVEL_NINE_LOOT_TABLE.concat([
                {
                    chance: 1 / 2,
                    rewards: [{ type: "item", itemId: "thors_skull", amount: 1 }]
                }
            ])
        )
    },
